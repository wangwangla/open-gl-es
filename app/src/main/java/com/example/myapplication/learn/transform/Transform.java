...
public class Transform extends BaseGameScreen {
...
//        GLES20.glUniform4fv(vChangeColor,1,new float[]{1,1,1,1},0);
    ...
    public void surfaceChange(int width, int height) {
        ...
        if(width>height){
            ...
            if(sWH>sWidthHeight){
                Matrix.orthoM(mProjectMatrix, 0, -sWidthHeight*sWH,sWidthHeight*sWH, -1,1, 3, 10);
            }else{
                Matrix.orthoM(mProjectMatrix, 0, -sWidthHeight/sWH,sWidthHeight/sWH, -1,1, 3, 10);
            }
        }
        ...
        //设置绕x轴旋转
        Matrix.rotateM(mModelMatrix,0,50,0,0,1);
