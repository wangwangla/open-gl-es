...
//
//        final String vertexShader = "uniform mat4 u_MVPMatrix;\t\t// A constant representing the combined model/view/projection matrix.      \t\t       \n" +
...
//                "} ";
//        final String fragmentShader = "precision mediump float;       \t// Set the default precision to medium. We don't need as high of a \n" +
