...
public class Blend01 extends BaseGameScreen {
    ...
    public Blend01(Context context){
...
//    private int vChangeColor;
    ...
    public void create() {
        ...
        try {
            mBitmap= BitmapFactory.decodeStream(context.getAssets().open("texture/texture01.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
