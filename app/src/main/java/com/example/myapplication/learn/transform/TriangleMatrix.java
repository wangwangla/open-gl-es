...
//        设置相机位置
        ...
        Matrix.setIdentityM(aa,0);
        Matrix.setRotateM(aa,0,0,0,1,0);
        //设置沿Z轴正向位移1
        Matrix.translateM(aa,0,0,1,1);
        //设置绕x轴旋转
        Matrix.rotateM(aa,0,10,1,0,0);
        Matrix.multiplyMM(mMVPMatrix,0,mViewMatrix,0,aa,0);
