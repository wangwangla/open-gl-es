package com.example.myapplication.bn.Sample5_9;
...
public class Belt {
	...
	public void initShader(MySurfaceView mv) {
		// 加载顶点着色器的脚本内容
		mVertexShader = ShaderUtil.loadFromAssetsFile("sample5_9/vertex.sh",
				mv.getResources());
		// 加载片元着色器的脚本内容
		mFragmentShader = ShaderUtil.loadFromAssetsFile("sample5_9/frag.sh",
				mv.getResources());
		// 基于顶点着色器与片元着色器创建程序
