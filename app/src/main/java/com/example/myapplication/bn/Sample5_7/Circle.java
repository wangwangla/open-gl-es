package com.example.myapplication.bn.Sample5_7;
...
{	
    ...
    {
    	//加载顶点着色器的脚本内容
        mVertexShader=ShaderUtil.loadFromAssetsFile("sample5_7/vertex.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("sample5_7/frag.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
