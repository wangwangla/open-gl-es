package com.example.myapplication.bn.Sample5_16;
import java.nio.ByteBuffer;

import static com.example.myapplication.bn.Sample5_16.Constant.*;
...
public class TrianglePair {
	...
	public void initShader(MySurfaceView mv) {
		// 加载顶点着色器的脚本内容
		mVertexShader = ShaderUtil.loadFromAssetsFile("sample5_15/vertex.sh",
				mv.getResources());
		// 加载片元着色器的脚本内容
		mFragmentShader = ShaderUtil.loadFromAssetsFile("sample5_15/frag.sh",
				mv.getResources());
		// 基于顶点着色器与片元着色器创建程序
