package com.example.myapplication.bn.Sample5_12;
...
import static com.example.myapplication.bn.Sample5_2.ShaderUtil.createProgram;
...
{	
 ...
 // 初始化顶点坐标数据的方法
   ...
   // 初始化着色器
    ...
    {
    	//加载顶点着色器的脚本内容
        mVertexShader=ShaderUtil.loadFromAssetsFile("sample5_12/vertex.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("sample5_12/frag.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
