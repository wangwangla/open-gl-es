package com.example.myapplication.bn.Sample5_1;
import static com.example.myapplication.bn.Sample5_1.ShaderUtil.createProgram;
...
{	
  ...
  //初始化着色器的initShader方法
    ...
    {
    	//加载顶点着色器的脚本内容
        mVertexShader=ShaderUtil.loadFromAssetsFile("sample5/vertex.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("sample5/frag.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
