package com.example.myapplication.bn.Sample5_10;
...
public class Circle {
	...
	public void initShader(MySurfaceView mv) {
		// 加载顶点着色器的脚本内容
		mVertexShader = ShaderUtil.loadFromAssetsFile("sample5_10/vertex.sh",
				mv.getResources());
		// 加载片元着色器的脚本内容
		mFragmentShader = ShaderUtil.loadFromAssetsFile("sample5_10/frag.sh",
				mv.getResources());
		// 基于顶点着色器与片元着色器创建程序
