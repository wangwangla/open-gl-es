package com.example.myapplication.bn.Sample6_1;

import java.nio.ByteBuffer;
import static com.example.myapplication.bn.Sample6_1.Constant.*;
...
public class Ball {
	...
	public void initShader(MySurfaceView mv) {
		// 加载顶点着色器的脚本内容
		mVertexShader = ShaderUtil.loadFromAssetsFile("sample6_1/vertex.sh",mv.getResources());
		// 加载片元着色器的脚本内容
		mFragmentShader = ShaderUtil.loadFromAssetsFile("sample6_1/frag.sh",mv.getResources());
		// 基于顶点着色器与片元着色器创建程序
