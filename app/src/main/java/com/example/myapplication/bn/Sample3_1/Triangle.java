package com.example.myapplication.bn.Sample3_1;
...
public class Triangle
{
    ...
    {
    	//加载顶点着色器的脚本内容
        mVertexShader=ShaderUtil.loadFromAssetsFile("sample3/vertex.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("sample3/frag.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
    ...
    public static float[] getFianlMatrix(float[] spec)
    {
        ...
        //设置绕x轴旋转
        Matrix.rotateM(mMMatrix,0,80,1,0,0);
